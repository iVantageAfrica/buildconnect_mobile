...
const ClientContractdetailsScreen = () => {
  return (
    ...
    <View className="pt-4">
     ...
     <View className="pt-4">
        <PrimaryButton title="Download Contract" textColor="black" backgroundColor="white" className="border  border-gray-300"/>
        </View>
      </View>
    </View>
    </AppLayout>
...
export default ClientContractdetailsScreen